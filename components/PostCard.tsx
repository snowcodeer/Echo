...
export default function PostCard({
  ...
  const { showTranscriptions } = useTranscription();
  ...
  return (
    <View style={[globalStyles.postCard, { marginHorizontal: spacing.xl }]}>
      <LinearGradient
        ...
        {/* Content - Conditionally rendered based on transcription setting */}
        {showTranscriptions && (
              ...
              <View key={reply.id} style={{ flexDirection: 'row', marginBottom: spacing.md }}>
                ...
                <View style={{ flex: 1, borderRadius: borderRadius.md, overflow: 'hidden' }}>
                  <LinearGradient
                    ...
                    {/* Reply Content - Conditionally rendered based on transcription setting */}
                    {showTranscriptions && (
                      <Text style={{ 
                        fontSize: 14, 
